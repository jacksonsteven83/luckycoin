...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x01000001; // addresses start with "Lkc"
...
const size_t   CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 10; // 解锁代币区块时间
